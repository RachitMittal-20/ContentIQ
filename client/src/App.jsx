...
function Landing({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const r = await fetch('https://snowshoe-seventeen-worsening.ngrok-free.dev/api/metadata');
  ...
  const apiAnalyze = async (videoA, videoB) => {
    ...
    const r = await fetch('https://snowshoe-seventeen-worsening.ngrok-free.dev/api/analyze', {
      method: 'POST',
